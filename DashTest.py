...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(yearly_rec, 
                x='Year',
                y='Average number of Automobile sales',
...
# grouping data for plotting.
        # Hint:Use the columns Year and Automobile_Sales
        avr_vdata=yearly_data.groupby('Vehicle_Type')['Automobile_Sale'].mean().reset_index()
    ...
    # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, names='Vehicle_Type', values='Expenditure', title='Total Expenditure Share by Vehicle Type in the year {}'.format(input_year)))
